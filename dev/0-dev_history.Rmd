...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Continuer de s'entraîner",
    Description = "TD2 en autonomie",
    `Authors@R` = c(
      person("Magali", "Dauvin", email = "magali.dauvin@sciencespo.fr", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Magali Dauvin")
```
